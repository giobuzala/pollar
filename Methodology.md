...
The pollar backend (`backend/R/model_core.R` and related R files) implements a probabilistic seat projection model for a federal election using province-level polling data and riding-level 2025 election results.
